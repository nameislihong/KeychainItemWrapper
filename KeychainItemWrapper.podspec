#
# Be sure to run `pod spec lint KeychainItemWrapper.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  s.homepage = 'http://developer.apple.com/library/ios/#samplecode/GenericKeychain/Listings/Classes_KeychainItemWrapper_m.html'
  s.author   = { 'Apple' => 'apple.com' }
  ...
  s.description = 'An optional longer description of KeychainItemWrapper.'
